...
process.source = cms.Source("PoolSource",
    ...
    'root://eoscms///store/user/taroni/ClusterSplitting/ZpTauTau8TeV/RECO-FEVT/ZpTauTau8TeV_simsplit_new.root'
),
)
...
process.RECOoutput.outputCommands.append('drop *_*_*_*')
process.RECOoutput.outputCommands.append( 'keep *_mix_*_*')
process.RECOoutput.outputCommands.append( 'keep Tracking*_*_*_*')
...
process.multiTrackValidator.outputFile = 'valid_SS_Zp8TeV_chi2_valOnly.root'
