...
//   gROOT->SetStyle("Plain");
  ...
  if (type=="ByChi2"){
    if (isRunI == true){
      ...
      filename.push_back("../valid_NS_Zp8TeV_chi2_valOnly.root");
      filename.push_back("../valid_TS_Zp8TeV_chi2_valOnly.root");
      filename.push_back("../valid_SS_Zp8TeV_chi2_valOnly.root");
    }
  }else if (type=="ByHits"){
