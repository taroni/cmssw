...
process.source = cms.Source("PoolSource",
    ...
    'root://eoscms///store/user/taroni/ClusterSplitting/ZpTauTau8TeV/RECO-FEVT/ZpTauTau8TeV_nosplit_new.root'
),
)
...
process.multiTrackValidator.outputFile = 'valid_NS_Zp8TeV_chi2_valOnly.root'
