...
ecalRecHit = cms.EDProducer("EcalRecHitProducer",
    ...
    bdtWeightFileNoCracks = cms.FileInPath("RecoLocalCalo/EcalDeadChannelRecoveryAlgos/data/bdtgAllRH_8GT700MeV_noCracks_ZskimData2017_v1.xml"),
    bdtWeightFileCracks = cms.FileInPath("RecoLocalCalo/EcalDeadChannelRecoveryAlgos/data/bdtgAllRH_8GT700MeV_onlyCracks_ZskimData2017_v1.xml"),
