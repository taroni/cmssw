...
#process.CondDBCommon.connect = 'oracle://cms_orcon_adg/CMS_COND_31X_ECAL' ##lxplus DBv1 obsolete
process.CondDBCommon.connect = 'oracle://cms_orcon_adg/CMS_CONDITIONS' ##lxplus DBv2
...
process.PoolDBESSource = cms.ESSource("PoolDBESSource",
            ...
            record = cms.string('EcalPedestalsRcd'),
                    ...
                    #connect = cms.untracked.string('oracle://cms_orcon_prod/CMS_COND_310X_ECAL_PED')
                 ),
              cms.PSet(
...
##    cms.PSet(
##      record = cms.string('EcalPedestalsRcd'),
##     tag = cms.string('EcalPedestals_200_194556_200469_206766_mc'),
##    ),
##    cms.PSet(
##      record = cms.string('EcalADCToGeVConstantRcd'),
...
#    DBsid   = cms.string('cms_omds_lb'), ## real DB 
    DBsid   = cms.string('cms_orcon_adg'), ## real DB 
...
#    DBpass  = cms.string('0r4cms_3c4lc0nf'),
    ...
    ##outFile = cms.string('TPG_beamv6_trans_400050_spikekill.txt'),
    ##outFile = cms.string('TPG_beamv6_trans_spikekill.txt'),
    outFile = cms.string('TPG_beamv6_trans_spikekill_FGEE_240ADC_LUT.txt'),
    ...
    ##transparency_corrections = cms.string('weekly_208752'), # transparency corr to be used to compute linearizer parameters 1/crysta
    transparency_corrections = cms.string('TRANSPARENCY_2016/weekly_282107'),
    ...
    FG_Threshold_EE = cms.double(240),         ## EE Fine threshold in GeV
    FG_lut_strip_EE = cms.uint32(0xfffefee8),  ## EE Fine Grain strip Look-up table
    FG_lut_tower_EE = cms.uint32(0xfffffffe)   ## EE Fine Grain tower Look-up table  
